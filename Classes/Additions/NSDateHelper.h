...
// Returns an NSDate with an DB Timestamp format, aka: yyyy-MM-dd'T'HH:mm:ss
...
// Returns date formatted for SQLite Timestamp columns: yyyy-MM-dd'T'HH:mm:ss
